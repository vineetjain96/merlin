...
from envs.env_util import create_stats_ordered_dict

import os.path as osp
import envs.sawyer_door_hook
...
class SawyerDoorGoalEnv(Wrapper):
    ...
    def __init__(self, fixed_start=True, fixed_goal=False, threshold=0.06):
        ...
        self.env = envs.sawyer_door_hook.SawyerDoorHookEnv(**door_configs[config_key])
